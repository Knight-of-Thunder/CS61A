...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    # Cut the scores to double digits
    player_score %= 100
    opponent_score %= 100
    
    add = abs(player_score % 10 - opponent_score//10) * 3
    if(add == 0):
        add = 1
    return add
    # END PROBLEM 2
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    if(num_rolls == 0):
        add_score = boar_brawl(player_score, opponent_score)
    else:
        add_score = roll_dice(num_rolls, dice)
    return add_score
    # END PROBLEM 3
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    now_score = pre_score = score
    now_score = pre_score + boar_brawl(score,opponent_score)
    now_score = sus_points(now_score)
    if(now_score - pre_score >=threshold):
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
